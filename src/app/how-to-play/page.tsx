    ...
    <div className="container mx-auto p-4 max-w-lg">
      ...
      <div className="border border-gray-300 rounded p-4 mb-6">
        ...
        <ol className="list-decimal pl-5 mb-4">
          ...
          <li>Choose your bet type: Single Ticket (bet on one two-digit number, from 00-99, compared against the four numbers of Prize 7 and the last two digits of the Special Prize) or Full Set Bet (bet on one two-digit number, 00-99, checked against the last two digits of all 27 prizes).</li>
...
Wallet = (your wallet address - optional but recommended).`}
      ...
      <div className="border border-gray-300 rounded p-4 mb-6">
        ...
        <p className="mb-4">Results are based on the Vietnam Northern Lottery. View official results at <a href="https://www.minhngoc.net.vn/ket-qua-xo-so/mien-bac.html" className="text-blue-500 hover:underline">ClickHere</a>.</p>
      </div>
