  ...
  return (
    <div className="container mx-auto p-4 max-w-lg">
      ...
      <ol className="list-decimal pl-5 mb-4">
        ...
        <li>Optionally, add a donation to support the operator.</li>
        <li>Review the total cost and place your bet before 14:00 UTC.</li>
      </ol>
      <h2 className="text-xl font-semibold mb-2">Fees and Donations</h2>
      <p className="mb-4">A fixed fee of 0.10 USDC is applied per transaction, regardless of the number of tickets. Donations are optional and can be set at your discretion.</p>
      ...
      <ul className="list-disc pl-5 mb-4">
        <li>Single Ticket: Total cost = Bet amount per position × 5 + 0.10 USDC fee + donation (if any).</li>
        <li>Example: Bet 0.30 USDC on one number, total = 0.30 × 5 + 0.10 = 1.60 USDC.</li>
        <li>Multiple Tickets: Total cost = Number of tickets × Bet amount per position × 5 + 0.10 USDC fee + donation (if any).</li>
